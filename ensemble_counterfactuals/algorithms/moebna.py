...
class UMDAmod(EBNA):
    ...
    def _check_generation_no_parallel(self, objective_function: callable):
        ...
        r = RankAndCrowding()
        _problem.evaluate
        sol = r.do(_problem,pop,n_survive=200,algorithm=algo)
...
def _eda_ensemble_mod(x_instance,y_desired,codification,X,model_name,pop_size=200,n_gen=20,period=20,one_sol=True,discrete_variables=None,graphic=False):
